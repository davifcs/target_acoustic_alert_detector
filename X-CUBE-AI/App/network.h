...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "epoch49val_avg_loss0_00val_avg_f10_98"
...
#define AI_NETWORK_IN_1_WIDTH       (27)
#define AI_NETWORK_IN_1_SIZE        (30 * 1 * 27)
#define AI_NETWORK_IN_1_SIZE_BYTES  (3240)
